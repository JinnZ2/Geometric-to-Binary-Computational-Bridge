...
GEV code is MIT; its bundled data carries its own terms (ODbL, PDDL, public domain, and one CC BY-NC-SA pack). This repo is CC-BY-4.0. Code may cross either way. Data crosses only with a consent record, and the NC pack does not cross.
