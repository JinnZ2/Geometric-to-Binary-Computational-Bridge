...
> **This file has been restructured. Content is now in [`Negentropic/`](Negentropic/).**

| File | Content |
|------|---------|
| [Negentropic/README.md](Negentropic/README.md) | Overview, confidence map, audit findings |
| [Negentropic/NEG_CLAIMS.md](Negentropic/NEG_CLAIMS.md) | Numbered claims with predictions, falsifiers, and status |
| [Negentropic/corrections.md](Negentropic/corrections.md) | Correction ledger — every defect found and its fix |
| [Negentropic/01-framework.md](Negentropic/01-framework.md) | Core equations: J, R_e, C, Φ, phase transitions |
...
dimensionally undefined in favour of the persistence criterion
`Φ = −Ṡ_exchange − σ ≥ 0`. See [`NEG_CLAIMS.md`](Negentropic/NEG_CLAIMS.md).
